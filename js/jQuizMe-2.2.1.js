...
(function($){	
	...
	_lang = {
			...
			btn:{	// [ "text", "title" ]
				...
				showOnlyMissed: [ " Check to Review Only Wrong Answers", "Click to show only missed questions." ],
				quit: [ "Quit", "Quit quiz" ],
				quitNo: [ "->", "Go Back" ],
				quitYes: [ '', "Yes, quit" ]
			},
	...
	_settings = {
		...
		numOfQuizQues: 20, // Sets the number of questions asked. Must be between 0 and the total questions.
		...
		showFeedback: false, // Show the answers after each question.
		showAnsInfo: false, // If provided, show the answers information after each question.
		...
		title: 'Drugs and Behaviour' // title displayed for quiz.
	};
